...
def main() -> None:
    ...
    df = run_passkey_benchmark(
        ...
        seeds=CONFIG["seeds"],
        prompt_kind="standard",
        max_new_tokens=CONFIG["max_new_tokens"],
        prune_after=CONFIG["prune_after"],
        chunk_size=CONFIG["chunk_size"],
        strategy=CONFIG["strategy"],
        output_csv=results_dir / "passkey_results.csv",
    )
    ...
    summary.to_csv(results_dir / "passkey_summary.csv", index=False)

    print(f"Saved {results_dir / 'passkey_results.csv'}")
    print(f"Saved {results_dir / 'passkey_summary.csv'}")
